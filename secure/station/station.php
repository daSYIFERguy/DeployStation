...
<html lang="en">
<head>
  <?= station_pwa_head_html($appName, 'Manage projects, GitHub connection, users, and station settings from one mobile-friendly workspace.', 'assets/style.css?v=20260519d') ?>
  <style>
    .station-body {
      margin: 0;
