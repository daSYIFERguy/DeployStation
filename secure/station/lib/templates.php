...
/**
 * Write a template definition into an existing project directory.
 *
 * @return array{ok: bool, message: string, template?: array<string, mixed>}
 */
function station_deploy_template_to_project_path(string $projectPath, string $templateType, string $projectName): array
{
